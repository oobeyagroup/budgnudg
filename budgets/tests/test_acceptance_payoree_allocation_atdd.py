...
class TestPayoreeCentricAllocationATDD(TestCase):
    ...
    def setUp(self):
        ...
        self.current_budget_plan = BudgetPlan.objects.create(
            name="October Budget", year=2025, month=10, is_active=True
        )
    ...
    def test_effective_category_display(self):
        ...
        self.assertEqual(
            utilities_allocation.effective_category, self.utilities_category
        )
    ...
    def test_multiple_payorees_same_category(self):
        ...
        safeway = Payoree.objects.create(
            name="Safeway", default_category=self.groceries_category
        )
        ...
        self.assertEqual(
            whole_foods_allocation.effective_category, self.groceries_category
        )
    ...
    def test_allocation_properties_and_methods(self):
        ...
        self.assertAlmostEqual(
            allocation.get_variance_percentage(), expected_variance_percentage, places=2
        )
