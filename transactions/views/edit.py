...
class TransactionEditView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request, 
            f'Transaction updated successfully: {self.object}'
        )
        return response
    ...
    def form_valid(self, form):
        ...
        return JsonResponse({
            ...
            'transaction': {
                ...
                'subcategory': self.object.subcategory.name if self.object.subcategory else None,
                'payoree': self.object.payoree.name if self.object.payoree else None,
            }
        })
