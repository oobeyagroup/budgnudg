...
class ImportRow(models.Model):
    ...
    class Meta:
        ordering = ["row_index"]
        constraints = [
            models.UniqueConstraint(fields=["batch", "row_index"], name="uniq_batch_rowid"),
        ]
        indexes = [
...
class ScannedCheck(models.Model):
    ...
    original_filename = models.CharField(max_length=255, db_index=True, blank=True, null=True)
    content_md5 = models.CharField(max_length=32, db_index=True, blank=True)  # set on save
    ...
    class Meta:
        constraints = [
            ...
            models.UniqueConstraint(fields=["content_md5"], name="unique_scannedcheck_md5")
        ]
