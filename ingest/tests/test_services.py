...
class TestMappingService:
    ...
    def test_map_row_with_ai_suggestions(self, mock_suggest_payoree, mock_suggest_subcategory):
    ...
    def test_apply_profile_to_batch_basic(self):
        ...
        ImportRow.objects.create(
            batch=batch,
            row_index=0,
            raw={"Date": "1/1/2023", "Description": "Transaction 1", "Amount": "100.00"}
        )
        ImportRow.objects.create(
            batch=batch,
            row_index=1,
            raw={"Date": "1/2/2023", "Description": "Transaction 2", "Amount": "-50.00"}
        )
...
class TestIntegrationScenarios:
    ...
    def test_full_csv_import_workflow(self):
        ...
        with patch('ingest.services.mapping.suggest_subcategory') as mock_subcat, \
             patch('ingest.services.mapping.suggest_payoree') as mock_payoree:
            # Provide enough mock values for all calls
            mock_subcat.return_value = "Coffee/Tea"  # Use return_value instead of side_effect
    ...
    def test_workflow_with_duplicates_and_errors(self, mock_is_duplicate):
        ...
        mock_is_duplicate.side_effect = [False, True, False]  # Provide enough values for all calls
